    ...
    <section className="max-w-7xl mx-auto">
      ...
      <div className="mt-16">
        <FormField
          ...
          type="text"
          name="text"
          placeholder="Find an image by name or prompt..."
          value={searchText}
      ...
      <div className="mt-10">
        {loading ? (
          ...
          <>
            {searchText && (
              <h2 className="font-medium text-base-400 text-xl mb-3">
                Showing Resuls for <span className="text-info">{searchText}</span>:
              </h2>
            )}
